...
def main() -> None:
    ...
    # Center-scored mode has a physical x prior: x remains at wafer center, and
    # a noisy lower row must not beat the nearest valid upper cross row.
